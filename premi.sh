...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO DEVCULTUR EXBIT VPN ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${purple}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green}DEVCULTUR EXBIT® ${NC}${YELLOW}(${NC}${green}V 3.2${NC}${YELLOW})${NC}"
echo -e " ›TEAM 🅥🅝: DEVCULTUR EXBIT ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
<code>─────────────────────────────</code>
<b> DEVCULTUR EXBIT VPN STORE SCRIPT  </b>
<code>─────────────────────────────</code>
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY DEVCULTUR EXBIT ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
